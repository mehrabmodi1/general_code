...
figure(1)
fig_h = scattered_dot_plot_ttest(scr_data, 1, 1, 4, 8, marker_colors, 1, col_pairs, line_colors, xlabels, 1, [0.8, 0.4, 0.4], 1, 0.05);
holf on
ax_vals = axis;
...
%Plotting fine discr and generalization for MB099C data
...
figure(2)
fig_h = scattered_dot_plot_ttest(beh_data, 2, 1, 4, 8, marker_colors, 1, col_pairs, line_colors, xlabels, 1, [0.8, 0.4, 0.4], 1, 0.05);
ylabel('performance index');
fig_wrapup(fig_h, []);
