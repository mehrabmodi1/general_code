function [sig_cell_mat, all_bad_trs] = cell_data_quality_control(dff_data_mat, stim_mat, stim_mat_simple, sig_cell_mat, suppress_plots, frame_time)
...
for odor_n = 1:length(odor_list)
    ...
    for train_n = 1:n_trains
        ...
        if suppress_plots == 0
            ...
            set_xlabels_time(1, frame_time./1, 1.1);
            fig_wrapup(1)
            ...
            set_xlabels_time(2, frame_time./1, 1.1);
            fig_wrapup(2)
        ...
        if q_n > 0
            ...
            if suppress_plots == 0
                ...
                colormap(greymap)
                ylabel('significant cell number')
                set_xlabels_time(3, frame_time./1, 1.1);
                fig_wrapup(3)
                ...
                colormap(greymap)
                ylabel('significant cell number')
                set_xlabels_time(4, frame_time./1, 1.1);
                fig_wrapup(4)
        ...
        sig_cell_mat(bad_cells, odor_ni) = 0;
         ...
         if suppress_plots == 0
            ...
            if q_n > 0
                ...
                colormap(greymap)
                ylabel('significant cell number')
                set_xlabels_time(7, frame_time./1, 1.1);
                fig_wrapup(7)
                ...
                colormap(greymap)
                ylabel('significant cell number')
                set_xlabels_time(8, frame_time./1, 1.1);
                fig_wrapup(8)
