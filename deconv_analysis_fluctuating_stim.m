    ...
    for direc_counter = 1:n_dirs
        ...
        for odor_n = 1:n_odors
            ...
            for train_n = 1:n_trains
                ...
                PID_trace = get_PID_traces(direc, curr_trs, frame_time);        %getting mean PID trace
                keyboard
                
                %PICK UP THREAD HERE
                %start coding in the kernel fitting. match up the lengths
                %of the dF/F response vectors and downsampled PID trace
                %vectors.
