function [dff_data_mat dff_data_mat_orig dffdata_peaks dffdata_peaks_orig trial_type_vec bad_cellsi bad_trialsi dff_data_mat_nans] = imaging_data_sanitiser2(dff_data_mat, dffdata_peaks, trial_type_vec, set_type)
...
dff_data_mat_nans = dff_data_mat;
    ...
    %nans are added as pad for pseudo datasets, hence not considering these
    if set_type == 1
        nans = 0;
    else
    end
