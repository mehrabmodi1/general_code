...
for odor_n = 1:n_odors
    ...
    for odor_dur_n = 1:n_odor_durs
        ...
        result_vec = [on_diff, ramp_diff, sus_diff, off_diff, r_multi_pk] .* h_vec;         %vector of effect sizes, non zero only if significantly different
...
%         end
    ...
    try
        r_vec = nanmean(r_vec_mat, 1).*h_vec;
    catch
        keyboard
    end
