%function [bad_trials] = slow_motion_checker(direc)
...
direc = 'C:\Data\CSHL\20140908\odor_stim_set2\';                        %directory with raw data in it. Don't forget the last '\'!
...
n_r_pairs = 30;                                                        %no of random aved frame pairs from within first trial compared to build dist of expected corr coefs
