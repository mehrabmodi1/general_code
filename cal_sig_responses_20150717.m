function [resp_areas, sig_trace_mat, sig_cell_mat, sig_cell_block_mat] = cal_sig_responses(dataset, dff_data_mat, stim_mat, prot_switch_trials)
...
%         end
%                 
        resp_trace = curr_trace(stim_frame:(stim_frame + floor(1500/frame_time)) );
