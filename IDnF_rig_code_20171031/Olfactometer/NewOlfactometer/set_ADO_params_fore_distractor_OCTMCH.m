function params=set_ADO_params_fore_distractor_OCTMCH(params)
...
defaults={...
    ...
    'duration', [6];...                %for rand trains - duration of train, for simple trains, duration of each pulse
    'odours',[1];...                    %olf1_list = [3, 5, 10, 11] corress olf2_list = [1, 3, 2, 4]
    'firstDilution',0.1;...
    'secondDilution',4900;...
    %simple train params
    ...
    'duration_olf2', [1];...            %for rand trains - duration of train, for simple trains, duration of each pulse
    'odours_olf2',[4];...                %olf1_list = [3, 5, 10, 11] corress olf2_list = [1, 3, 2, 4]
    'rel_stimLatency_olf2', 13;...       %stim latency of olfactometer2 pulse train relative to olfactometer1 pulse train
    %simple train params
    'n_od_pulses_olf2', 10;...           %will deliver n_odor_pulses of length duration and inter_pulse_interval in between
    'inter_pulse_interval_olf2', 20;...
