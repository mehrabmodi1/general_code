function params=set_ADO_params_olf1_olf2_relay(params)
...
defaults={...
    ...
    'duration', [10];...                %for rand trains - duration of train, for simple trains, duration of each pulse
    'odours',[5];...                    %olf1_list = [3, 5, 10, 11] corress olf2_list = [1, 3, 2, 4]
    'firstDilution',0.1;...
    'secondDilution',4900;...
    %simple train params
    'n_od_pulses', 1;...                %will deliver n_odor_pulses of length duration and inter_pulse_interval in between
    'inter_pulse_interval', 5;...
    ...
    'duration_olf2', [10];...            %for rand trains - duration of train, for simple trains, duration of each pulse
    'odours_olf2',[3];...                %olf1_list = [3, 5, 10, 11] corress olf2_list = [1, 3, 2, 4]
    'rel_stimLatency_olf2', 5;...       %stim latency of olfactometer2 pulse train relative to olfactometer1 pulse train
    %simple train params
    'n_od_pulses_olf2', 1;...           %will deliver n_odor_pulses of length duration and inter_pulse_interval in between
    'inter_pulse_interval_olf2', 4;...
