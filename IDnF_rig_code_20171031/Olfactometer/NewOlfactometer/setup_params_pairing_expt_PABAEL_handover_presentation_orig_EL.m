function [params_spec1] = setup_params_pairing_expt_PABAEL_handover_presentation_orig_EL()
...
%step 1.3 adding handover olf1-olf2 trials (EL to CS+ odor trials)
...
%step 1.4 adding handover olf1-olf2 trials (EL to CS- odor trials)   
params_spec2 = params_spec1;
params_spec2.odours = 11;%EL
