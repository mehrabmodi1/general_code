...
%step2: Setting up the pairing trial5
...
%step4: Adding on two reps each of OCT and MCH 
params_spec3 = set_ADO_params_default;
params_spec3.odours = [1, 4];
params_spec3.duration = 10;
params_spec3.isi = 70;
params_spec3.reps = 2;
params_spec3.stimLatency = 7;
params_spec3.post_od_scan_dur = 7;

params_struc3 = setUpStimuli_trains_flex(params_spec3);
