function params=setUpStimuli_mehrab_20160621(params)
...
%in params)
stimGridFields={'duration','stimLatency','odours','isi','firstDilution','secondDilution', 'n_od_pulses', 'inter_pulse_interval'};
...
for pp=1:length(params) %this loop is not for trials
    ...
    %the list of odour names
    params.trs_done = zeros(1, n_trials);
