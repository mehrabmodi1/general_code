function [params_spec1] = setup_params_handover_pairing_expt_PABAEL_Berry_shock_calib(LED_elec_on, EL_type, int_pulse_int, pulse2_dur, image_stim_trs)
...
elseif LED_elec_on == 2 %case where US is delivered as shock pulses
    ...
    params_spec2.st_duty_cyc = 10;  %10 percent of 200 ms (20 ms)
    params_spec2.rel_stim_init_delay = 2;
