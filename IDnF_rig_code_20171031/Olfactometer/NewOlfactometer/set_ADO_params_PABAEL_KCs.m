function params=set_ADO_params_PABAEL_KCs(params)
...
defaults={...
    ...
    'duration', [60];...                %for rand trains - duration of train, for simple trains, duration of each pulse
    'odours',[3, 10, 11];...                    %olf1_list = [3, 5, 10, 11] corress olf2_list = [1, 3, 2, 4]
    'firstDilution',0.5;...
    'secondDilution',4900;...
    %simple train params
