function params=set_ADO_params_fore_distracter_HepIAA_control(params)
...
defaults={...
    ...
    'duration', [9];...                %for rand trains - duration of train, for simple trains, duration of each pulse
    'odours',[5];...                    %olf1_list = [3, 5, 9, 11] corress olf2_list = [1, 3, 2, 4]
    'firstDilution',0.1;...
    'secondDilution',4600;...
    %simple train params
    'n_od_pulses', 10;...                %will deliver n_odor_pulses of length duration and inter_pulse_interval in between
    'inter_pulse_interval', 12;...
    ...
    'duration_olf2', [];...            %for rand trains - duration of train, for simple trains, duration of each pulse
    'odours_olf2',[];...                %olf1_list = [3, 5, 10, 11] corress olf2_list = [1, 3, 2, 4]
    'rel_stimLatency_olf2', 22;...       %stim latency of olfactometer2 pulse train relative to olfactometer1 pulse train
    %simple train params
