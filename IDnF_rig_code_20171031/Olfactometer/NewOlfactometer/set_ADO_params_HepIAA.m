function params=set_ADO_params_HepIAA(params)
...
defaults={...
    ...
    'odours',[5, 9, 11];...                    %olf1_list = [3, 5, 9, 11] corress olf2_list = [1, 3, 2, 4]
    'firstDilution',0.1;...
    'secondDilution',4600;...
    %simple train params
    ...
    'odours_olf2',[2];...                %olf1_list = [3, 5, 9, 11] corress olf2_list = [1, 3, 2, 4]
