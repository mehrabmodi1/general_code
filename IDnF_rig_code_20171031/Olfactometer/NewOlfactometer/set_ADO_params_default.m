...
defaults={...
    ...
    'rel_stimLatency_olf2', 10;...       %stim latency of olfactometer2 pulse train relative to olfactometer1 pulse train
    'odours_olf2',[1];...       %olf1_list = [3, 5, 10, 11] corress olf2_list = [1, 3, 2, 4]
    %simple train params
