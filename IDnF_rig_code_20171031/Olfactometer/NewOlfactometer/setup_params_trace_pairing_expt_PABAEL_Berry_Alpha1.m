function [params_spec1] = setup_params_trace_pairing_expt_PABAEL_Berry_Alpha1(LED_on, trace_interval)
...
log_file_path = 'E:\Turner lab\Bitbucket_repos\general_code\IDnF_rig_code_20171031\Olfactometer\NewOlfactometer\reciprocal_expt_logs\pairing_expt_PABAEL_trace_presentation_Alpha1.mat';
% last_paired_od = load(log_file_path);
% last_paired_od = last_paired_od.last_paired_od;
last_paired_od = 10;
odors_to_switch = [10, 4];     %PA and BA on olf2
...
params_spec2.stim_dur = (params_spec2.duration - params_spec2.rel_stim_init_delay);
params_spec2.stim_freq = 1;
params_spec2.st_duty_cyc = 50;
params_spec2.rel_stim_init_delay = (2 + trace_interval);
params_spec2.isi = 45 + trace_interval;     
...
params_spec3.stim_dur = 0;
params_spec3.led_odours = [];
