...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     
   ...
   if length( data ) == 3
      ...
      [error, img] = plot_venn2( data(1), data(2), data(3), resolution, dist, text_on );
      error = data - error';
   elseif length( data ) == 7 
       ...
       [error, img] = plot_venn3( data(1), data(2), data(3), data(4), data(5), data(6), data(7), ...
           resolution, dist_A_B, dist_B_C, dist_A_C , text_on);
       error = data - error';
   else
...
function [error, img] = plot_venn3( a, b, c, d, e, f, g, resolution, dist_A_B, dist_B_C, dist_A_C, text_on )
...
function [error, img] = plot_venn2( a, b, c, resolution, dist, text_on )
    r1 = sqrt( (a+b)/pi );
    r2 = sqrt( (b+c)/pi );
