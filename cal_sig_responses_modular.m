function [resp_sizes, sig_trace_mat, sig_trace_mat_old, sig_cell_mat, resp_areaundercurves] = cal_sig_responses_modular(dff_data_mat, stim_mat_struc, stim_mat_simple, direc, frame_time)
