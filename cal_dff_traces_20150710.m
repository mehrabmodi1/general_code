function [dff_data_mat, stim_mat, prot_switch_trials] = cal_dff_traces_20150710(raw_data_mat, dataset, list_direc)
...
for trial_n = 1:n_trials
    ...
    stim_vec = [odor_n, elec_stim, led_stim];
    ...
    if dataset(trial_n).process.good_trial == 0
