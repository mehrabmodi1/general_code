...
for list_n = 1:size(dataset_list_paths, 1)
    ...
    for dir_n = 1:n_dirs
       ...
       %Reading in experimental parameters
        ...
        [resp_sizes, sig_trace_mat, sig_trace_mat_old, sig_cell_mat, resp_areas] = cal_sig_responses_res_modular(dff_data_mat, stim_mat, stim_mat_simple, curr_dir, frame_time);
