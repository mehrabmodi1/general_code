...
%PA
plot_simple_traces(3, 1, PA_color, 1, 2, stim_mat, stim_mat_simple, od_col_ns, dur_col_ns, curr_dir, y_ax_lim)

%BA
plot_simple_traces(10, 3, BA_color, 3, 4, stim_mat, stim_mat_simple, od_col_ns, dur_col_ns, curr_dir, y_ax_lim)

%EL
plot_simple_traces(11, 4, EL_color, 5, 6, stim_mat, stim_mat_simple, od_col_ns, dur_col_ns, curr_dir, y_ax_lim)

%plotting handover odor pulse PID traces
%BA-BA
plot_hover_traces(10, 3, BA_color, BA_color, 13, stim_mat, stim_mat_simple, od_col_ns, dur_col_ns, curr_dir, y_ax_lim)

%PA-BA
plot_hover_traces(3, 3, PA_color, BA_color, 7, stim_mat, stim_mat_simple, od_col_ns, dur_col_ns, curr_dir, y_ax_lim)
%PA-EL
plot_hover_traces(3, 4, PA_color, EL_color, 8, stim_mat, stim_mat_simple, od_col_ns, dur_col_ns, curr_dir, y_ax_lim)

%BA-PA
plot_hover_traces(10, 1, BA_color, PA_color, 9, stim_mat, stim_mat_simple, od_col_ns, dur_col_ns, curr_dir, y_ax_lim)
%BA-EL
plot_hover_traces(10, 4, BA_color, EL_color, 10, stim_mat, stim_mat_simple, od_col_ns, dur_col_ns, curr_dir, y_ax_lim)

%EL-PA
plot_hover_traces(11, 1, EL_color, PA_color, 11, stim_mat, stim_mat_simple, od_col_ns, dur_col_ns, curr_dir, y_ax_lim)
%EL-BA
plot_hover_traces(11, 3, EL_color, BA_color, 12, stim_mat, stim_mat_simple, od_col_ns, dur_col_ns, curr_dir, y_ax_lim)




function [] = plot_simple_traces(olf1_odn, olf2_odn, od_color, fign1, fign2, stim_mat, stim_mat_simple, od_col_ns, dur_col_ns, curr_dir, y_ax_lim)
frame_time = 0.099;
...
function [] = plot_hover_traces(olf1_odn, olf2_odn, od1_color, od2_color, fign, stim_mat, stim_mat_simple, od_col_ns, dur_col_ns, curr_dir, y_ax_lim)
frame_time = 0.099;
