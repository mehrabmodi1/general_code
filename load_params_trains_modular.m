...
for trial_n = 1:n_matched_trials
    ...
    stim_mat(trial_n).pulse_type = params(curr_tr_p).pulse_type;
    stim_mat(trial_n).pulse_train = params(curr_tr_p).pulse_train;
    stim_mat(trial_n).pulse_train_n = params(curr_tr_p).pulse_train_n;
    stim_mat(trial_n).rand_trains = params(curr_tr_p).rand_trains;
    stim_mat(trial_n).duration_olf2 = params(curr_tr_p).duration_olf2;
    stim_mat(trial_n).rel_stimLatency_olf2 = params(curr_tr_p).rel_stimLatency_olf2;
    stim_mat(trial_n).odours_olf2 = params(curr_tr_p).odours_olf2;
    stim_mat(trial_n).n_od_pulses_olf2 = params(curr_tr_p).n_od_pulses_olf2;
    stim_mat(trial_n).inter_pulse_interval_olf2 = params(curr_tr_p).inter_pulse_interval_olf2;
    stim_mat(trial_n).mean_rand_pulse_dur_olf2 = params(curr_tr_p).mean_rand_pulse_dur_olf2;
    stim_mat(trial_n).rand_trains_olf2 = params(curr_tr_p).rand_trains_olf2;
    stim_mat(trial_n).pulse_train_olf2 = params(curr_tr_p).pulse_train_olf2;
    stim_mat(trial_n).pulse_train_n_olf2 = params(curr_tr_p).pulse_train_n_olf2;
    stim_mat(trial_n).duration_olf2 = params(curr_tr_p).duration_olf2;
    stim_mat(trial_n).led_on = params(curr_tr_p).led_on;
    stim_mat(trial_n).elec_on = params(curr_tr_p).elec_on;
    stim_mat(trial_n).rel_stim_init_delay = params(curr_tr_p).rel_stim_init_delay;
