function [resp_areas, sig_trace_mat, sig_cell_mat, sig_cell_block_mat] = cal_sig_responses_2016017(dataset, dff_data_mat, stim_mat, prot_switch_trials, list_direc, an_trial_window)
